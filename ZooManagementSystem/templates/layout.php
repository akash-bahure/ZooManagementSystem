    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-lg-8 col-md-6 mb-4">
          ...
          <p class="text-muted text-small">Zoo Management System is a web-based technology that manages peoples', and animals' details and provides tickets to the person who comes to visit in the zoo with his/her family. This web application provides a way to effectively control records & track the people who visit the zoo.</p>
          <p class="text-muted text-small">the Zoo has initially been set up to entertain people. Gradually, they have played an essential role in nature maintenance.The goal of the Zoo is conservation. </p>
        </div>
