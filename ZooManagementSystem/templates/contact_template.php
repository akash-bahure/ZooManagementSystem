<section class="py-5 bg-cover bg-gray">
    <div class="container py-5">
        ...
        <p class="lead my-4">Thank you for your interest in our Zoo Management System. We are committed to providing exceptional customer support and service to ensure that your experience with our system is seamless and hassle-free.</p>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-6 mb-4">
                        ...
                        <p class="text-muted mb-3 text-small">Our call center is dedicated to providing you with exceptional customer support and service.</p>
            ...
            <div class="col-lg-7 ml-auto">
                <div class="col-lg-12 col-md-6 mb-4">
                    ...
                    <p class="text-muted text-small">please fill the following form with your detail and write your message in the message box and subject also.</p>
