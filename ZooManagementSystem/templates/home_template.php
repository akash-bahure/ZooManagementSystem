<section style="background: url(../img/zoobg.jpg)" class="py-5 bg-cover bg-center">
    ...
    <div class="container py-5 px-0 text-white text-left">
       <center> <h1 class="text-shadow hero-heading font-weight-normal">Zoo Management System</h1>
        <p class="text-shadow font-weight-light mt-3 mb-4" style="width: 40%">
        "Zoo Management System is the ultimate tool for managing zoo operations, enhancing visitor experience, and ensuring animal welfare."
        </p></center>
    </div>
</section>
        ...
        <div class="row px-2">
            <div class="col-lg-6 col-sm-12">
                ...
                <p class="lead text-secondary">
                    A Visits to a Zoo offers us an opportunity to see the wild animals.Zoo is a place Where we can see Different animals and birds at one place.it has great attraction particularly for the children.Zoo gives Us Both Information And entertainment.we come to learn about the rare species.
                </p>
                <p class="text-small text-secondary">Thank you for choosing our Zoo Management System.please go ahead and register and then login for booking the ticket of Zoo.Price of tickets is very low But you will not be get disappointment here. We look forward to working with you and helping you manage your zoo operations efficiently.</p>
